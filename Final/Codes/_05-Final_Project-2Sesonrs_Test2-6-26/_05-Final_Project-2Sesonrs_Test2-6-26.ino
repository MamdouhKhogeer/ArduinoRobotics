...
void loop() {
  ...
  if (distance2 < 90 ) {
    ...
    delay(1);
    digitalWrite (mtr_1_p1, HIGH);
    digitalWrite (mtr_1_p2, LOW);
    analogWrite (mtr_1_spd, 255);

  } else if (190 > distance2 > 200) {
    Serial.println("Going Backward");
    delay(1);
    digitalWrite (mtr_1_p1, LOW);
    digitalWrite (mtr_1_p2, HIGH);
    analogWrite (mtr_1_spd, 255);
  } else {
    Serial.println("middle");
  }
